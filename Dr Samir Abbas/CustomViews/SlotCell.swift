...
class SlotCell : UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String!) {
        ...
        let myCollectionView:UICollectionView = UICollectionView(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width - Style.Height25 - 40, height: 100), collectionViewLayout: layout)
        ...
        contentView.addSubview(slotLayout)
