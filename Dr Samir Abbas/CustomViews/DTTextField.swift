...
public class DTTextField: UITextField {
    ...
    public var dtborderStyle:DTBorderStyle = .rounded{
        didSet{
            ...
            case .rounded:
                ...
                dtLayer.borderColor         = borderColor2.cgColor
            case .sqare:
                dtLayer.cornerRadius        = 0.0
                dtLayer.borderWidth         = 0.5
                dtLayer.borderColor         = borderColor2.cgColor
    ...
    public var borderColor2:UIColor = UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0){
        didSet{ dtLayer.borderColor = borderColor2.cgColor }
    }
